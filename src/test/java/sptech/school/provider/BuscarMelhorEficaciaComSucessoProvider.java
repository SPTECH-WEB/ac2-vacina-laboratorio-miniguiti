...
public class BuscarMelhorEficaciaComSucessoProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
        return Stream.of(
                ...
                Arguments.of(
                        List.of(
                                VacinaFactory.build("COV19", "Covid 19", "Ácidos Nucleicos", 89.99, 94.9, LocalDate.of(2020, 9, 17)),
                                VacinaFactory.build("GRP", "Gripe", "Subunidades", 219.90, 94.8, LocalDate.of(2018, 10, 26)),
                                VacinaFactory.build("HPV", "HPV", "Subunidades", 149.90, 94.7, LocalDate.of(2013, 6, 14))
                        ),
                        VacinaFactory.build("COV19", "Covid 19", "Ácidos Nucleicos", 89.99, 94.9, LocalDate.of(2020, 9, 17))
                )
        );
